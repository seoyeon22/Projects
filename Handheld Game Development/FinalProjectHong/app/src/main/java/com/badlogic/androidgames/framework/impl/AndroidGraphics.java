...
public class AndroidGraphics implements Graphics {
    ...
    public void drawRect(int x, int y, int width, int height, int color) {
        ...
        canvas.drawRect(x, y, x + width - 1, y + height - 1, paint); // use width and height to draw rectangle
    }
    ...
    /**
     * draw pixmap using matrix
     * @param pixmap image
     * @param matrix contains rotate and translate information
     */
